...
\begin{figure}[htbp]
    ...
    \caption{Experimental hardware setup with Jetson AGX Orin, Kria KV260, and the IMX636 event camera.}
...
\begin{tikzpicture}[
    ...
    % Top row
    \node[box, text width=2.0cm] (camera) at (-3.5,0)
        {IMX636\\
        Event Camera};

    \node[box, text width=2.8cm] (kria) at (1,0)
        {Kria KV260\\
        {\ttfamily Metavision}\\
